...
def main():
    ...
    # матрица векторов комментов и модель
    X_matrix = pt.vectorize_text(comments_clean, tfidf)

    # разделение текста на метики при помощи кластеризации, выбор наилучшего числа кластеров
    ...
    # получение последней версии модели и сохранение в файлы
    client = MlflowClient()
